            ...
            <div className="flex">
                ...
                <div className="w-3/4 h-screen">
                    ...
                    <form className='my-3 rounded-lg shadow-lg p-5 w-1/2'>
                        ...
                        <div className="flex">
                            <button type="button" class="mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-1/2" onClick={handleSubmit}>Add Category</button>
